  ...
  render2D: function (element, layer, scene) {
    ...
    return (
      ...
      <g transform={`translate(${-WIDTH / 2},${-DEPTH / 2})`}>
        ...
        style={{outline: element.selected ? '1px solid #db3f28' : '1px solid #bb7128', outlineOffset: '-1px', fill: '#d1a52c'}}/>
        <text key='2' x='0' y='0' transform={`translate(${WIDTH / 2}, ${DEPTH / 2}) scale(1,-1) rotate(${textRotation})`}
          style={{textAnchor: 'middle', fontSize: '3px'}}>
        <tspan>{userFacingName}</tspan>
              <tspan x='0' dy='1.2em' style={{fontSize: '3px'}}>{userFacingDimensions}</tspan></text>
      </g>
    )
  },
