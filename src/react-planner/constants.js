...
export const SET_GLOBAL_TEXTURE = 'SET_GLOBAL_TEXTURE';
...
export const Vertice1_ID = "SyeqgxXrR7";
export const Vertice2_ID = "H1b9leXrCQ";
export const Vertice3_ID = "r1ebbxXrCQ";
export const Vertice4_ID = "ryLV-lXH0X";
