...
import { tops, body } from "../catalog/cabinets/Cabinet_Textures/mtl/textures_obj";
...
export class Scene extends Record(
  {
    ...
    guides: new Map(),
    bodyTexture: body[Object.keys(body)[0]],
    topTexture: tops[Object.keys(tops)[0]],
  },
  "Scene"
) {
  constructor(json = {}) {
