...
export default class FooterBar extends Component {
  ...
  render() {
    ...
    const darkModeClass = this.state.darkMode ? "dark-mode" : "";

    return (
      <div className='footer_parent_div' style={{ ...footerBarStyle, width, height }}>
        ...
        <div className='footer_div footer_light_dark_div' style={leftTextStyle}>
          <FooterToggleButton
            state={this.state}
            toggleOn={this.toggleDarkMode}
            toggleOff={this.toggleDarkMode}
            text={this.state.darkMode ? "Dark" : "Light"}
            toggleState={this.state.darkMode}
        ...
        {this.props.softwareSignature ? (
          <div
            className='footer_div footer_copyright'
          ...
          >
            &copy;{new Date().getFullYear()} Merchants Fixture
          </div>
        ) : null}

        <div className='footer_div footer_info' style={rightTextStyle}>
          <FooterContentButton
            state={this.state}
            icon={MdAddCircle}
