...
import {FaCaretRight, FaQuestion, FaFile, FaFolderOpen, FaPlus, FaRotateLeft, FaPaperPlane, FaCamera, FaTable, FaCube, FaFloppyO} from 'react-icons/lib/fa';
...
export default class ToolbarButton extends Component {
  ...
  render() {
    ...
    className = className +' '+ props.extraClass;
