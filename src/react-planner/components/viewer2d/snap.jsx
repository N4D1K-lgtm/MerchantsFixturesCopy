...
export default function ActiveDrawingHelper({snap, width, height}) {
  switch (snap.type) {
    case 'point':
      return (
        <g transform={`translate(${snap.x} ${snap.y})`}>
          <line className="snap_guide" x1="0" y1="-70" x2="0" y2="70" style={STYLE}/>
          <line className="snap_guide" x1="-70" y1="0" x2="70" y2="0" style={STYLE}/>
        </g>);
    ...
    case 'line':
      ...
      if (pointH0 && pointH1)
        return <line className="snap_guide" x1={pointH0.x} y1={pointH0.y} x2={pointH1.x} y2={pointH1.y} style={STYLE}/>;
      if (pointV0 && pointV1)
        return <line className="snap_guide" x1={pointV0.x} y1={pointV0.y} x2={pointV1.x} y2={pointV1.y} style={STYLE}/>;
      return null;

    case'line-segment':
      return <line className="snap_guide" x1={snap.x1} y1={snap.y1} x2={snap.x2} y2={snap.y2} style={STYLE}/>;
