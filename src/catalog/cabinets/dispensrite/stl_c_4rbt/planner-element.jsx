import obj from './stl_c_4rbt.obj';
...
const userFacingName = 'stl_c_4rbt R (4) Cup Multi-Dispenser';
const userFacingTitle = 'R (4) Cup, Lid, & Straw Dispenser';
...
export default {
  ...
  info: {
    ...
    image: new URL('./stl_c_4rbt.png', import.meta.url),
    item_width: WIDTH,
    item_depth: DEPTH
  },
