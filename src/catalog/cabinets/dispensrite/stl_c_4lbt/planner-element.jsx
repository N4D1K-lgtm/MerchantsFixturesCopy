import obj from './stl_c_4lbt.obj';
...
const userFacingName = 'stl_c_4lbt L (4) Cup Multi-Dispenser';
const userFacingTitle = 'L (4) Cup, Lid, and Straw Dispenser';
...
export default {
  ...
  info: {
    ...
    image: new URL('./stl_c_4lbt.png', import.meta.url),
    item_width: WIDTH,
    item_depth: DEPTH
  },
