...
const userFacingName = 'stl_s_3bt 3-Cup Dispenser';
const userFacingTitle = '(3) Cup Dispenser';
...
export default {
  ...
  info: {
    ...
    image: new URL('./stl_s_3bt.png', import.meta.url),
    item_width: WIDTH,
    item_depth: DEPTH
  },
