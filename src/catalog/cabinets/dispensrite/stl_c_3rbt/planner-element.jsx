import obj from './stl_c_3rbt.obj';
...
const userFacingName = 'stl_c_3rbt R 3-Cup Multi-Dispenser';
const userFacingTitle = 'R (3) Cup, Lid, & Straw Dispenser';
...
export default {
  ...
  info: {
    ...
    image: new URL('./stl_c_3rbt.png', import.meta.url),
    item_width: WIDTH,
    item_depth: DEPTH
  },
