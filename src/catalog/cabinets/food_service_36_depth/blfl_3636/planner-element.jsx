...
const userFacingName = 'blfl_3636 Low Cabinet';
const userFacingTitle = '36" Low Cabinet';
...
export default {
  ...
  info: {
    ...
    image: new URL('./blfl_3636.png', import.meta.url),
    item_width: WIDTH,
    item_depth: DEPTH
  },
