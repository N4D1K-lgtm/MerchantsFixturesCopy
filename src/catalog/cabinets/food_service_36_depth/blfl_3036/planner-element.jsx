...
const userFacingName = 'blfl_3036 Low Cabinet';
const userFacingTitle = '30" Low Cabinet';
...
export default {
  ...
  info: {
    ...
    image: new URL('./blfl_3036.png', import.meta.url),
    item_width: WIDTH,
    item_depth: DEPTH
  },
