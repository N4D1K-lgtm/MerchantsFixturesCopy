...
const userFacingName = 'blfo_2436 Open Cabinet';
const userFacingTitle = '24" Open Cabinet w/ Shelf';
const userFacingDimensions = '24" x 36"';
...
export default {
  ...
  info: {
    ...
    image: new URL('./blfo_2436.png', import.meta.url),
    item_width: WIDTH,
    item_depth: DEPTH
  },
