...
const userFacingName = 'blsz_2424 Safe Cabinet';
const userFacingTitle = '24" Safe Cabinet';
...
export default {
  ...
  info: {
    ...
    image: new URL('./blsz_2424.png', import.meta.url),
    item_width: WIDTH,
    item_depth: DEPTH
  },
