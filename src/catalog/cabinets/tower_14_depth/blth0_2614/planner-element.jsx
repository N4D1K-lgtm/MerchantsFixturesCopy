import obj from './blth0_2614.obj';
...
const userFacingName = 'blth0_2614 Sales Tower';
const userFacingTitle = '26" Sales Tower';
...
export default {
  ...
  info: {
    ...
    image: new URL('./blth0_2614.png', import.meta.url),
    item_width: WIDTH,
    item_depth: DEPTH
  },
