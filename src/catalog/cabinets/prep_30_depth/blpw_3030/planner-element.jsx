...
const userFacingName = 'blpw_3030 Corner Cabinet';
const userFacingTitle = '30" Corner Cabinet';
...
export default {
  ...
  info: {
    ...
    image: new URL('./blpw_3030.png', import.meta.url),
    item_width: WIDTH,
    item_depth: DEPTH
  },
