...
const userFacingName = 'blsb_2430 Bagger Cabinet';
const userFacingTitle = '24" Bagger Cabinet';
...
export default {
  ...
  info: {
    ...
    image: new URL('./blsb_2430.png', import.meta.url),
    item_width: WIDTH,
    item_depth: DEPTH
  },
