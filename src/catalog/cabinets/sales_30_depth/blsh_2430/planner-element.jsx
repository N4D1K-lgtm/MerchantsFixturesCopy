...
const userFacingName = 'blsh_2430 Undercounter Shelving Cabinet';
const userFacingTitle = '24" Undercounter Shelving Cabinet';
const userFacingDimensions = '24" x 30"';
...
export default {
  ...
  info: {
    ...
    image: new URL('./blsh_2430.png', import.meta.url),
    item_width: WIDTH,
    item_depth: DEPTH
  },
