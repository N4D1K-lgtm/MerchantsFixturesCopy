...
const userFacingName = 'blpp_1236 (1) Door Cabinet';
const userFacingTitle = '12" (1) Door Cabinet w/ Shelf';
const userFacingDimensions = '12" x 36"';
...
export default {
  ...
  info: {
    ...
    image: new URL('./blpp_1236.png', import.meta.url),
    item_width: WIDTH,
    item_depth: DEPTH
  },
