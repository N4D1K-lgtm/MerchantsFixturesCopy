...
const userFacingName = 'blpo_1836 Open Cabinet';
const userFacingTitle = '18" Open Cabinet w/ Shelf';
...
export default {
  ...
  info: {
    ...
    image: new URL('./blpo_1836.png', import.meta.url),
    item_width: WIDTH,
    item_depth: DEPTH
  },
