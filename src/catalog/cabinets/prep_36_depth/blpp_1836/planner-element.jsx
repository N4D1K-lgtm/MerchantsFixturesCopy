...
const userFacingName = 'blpp_1836 (1) Door Cabinet';
const userFacingTitle = '18" (1) Door Cabinet w/ Shelf';
...
export default {
  ...
  info: {
    ...
    image: new URL('./blpp_1836.png', import.meta.url),
    item_width: WIDTH,
    item_depth: DEPTH
  },
