...
const userFacingName = 'blbt_1836 Trash Flipper Cabinet';
const userFacingTitle = '18" Trash Flipper Cabinet';
const userFacingDimensions = '18" x 36"';
...
export default {
  ...
  info: {
    ...
    image: new URL('./blbt_1836.png', import.meta.url),
    item_width: WIDTH,
    item_depth: DEPTH
  },
