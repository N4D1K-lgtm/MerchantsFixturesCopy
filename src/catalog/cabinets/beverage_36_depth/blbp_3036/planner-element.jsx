...
const userFacingName = 'blbp_3036 (2) Door Cabinet';
const userFacingTitle = '30" (2) Door Cabinet w/ Shelf';
const userFacingDimensions = '30" x 36"';
...
export default {
  ...
  info: {
    ...
    image: new URL('./blbp_3036.png', import.meta.url),
    item_width: WIDTH,
    item_depth: DEPTH
  },
