...
const userFacingName = 'blbp_1230 (1) Door Cabinet';
const userFacingTitle = '12" (1) Door Cabinet w/ Shelf';
const userFacingDimensions = '12" x 30"';
...
export default {
  ...
  info: {
    ...
    image: new URL('./blbp_1230.png', import.meta.url),
    item_width: WIDTH,
    item_depth: DEPTH
  },
