...
const userFacingName = 'blpt_1824 Trash Chute Cabinet';
const userFacingTitle = '18" Trash Chute Cabinet';
...
export default {
  ...
  info: {
    ...
    image: new URL('./blpt_1824.png', import.meta.url),
    item_width: WIDTH,
    item_depth: DEPTH
  },
