...
const userFacingName = 'blpw_2424 Corner Cabinet';
const userFacingTitle = '24" Corner Cabinet';
...
export default {
  ...
  info: {
    ...
    image: new URL('./blpw_2424.png', import.meta.url),
    item_width: WIDTH,
    item_depth: DEPTH
  },
