...
const userFacingName = 'blfl_2430 Low Cabinet';
const userFacingTitle = '24" Low Cabinet';
...
export default {
  ...
  info: {
    ...
    image: new URL('./blfl_2430.png', import.meta.url),
    item_width: WIDTH,
    item_depth: DEPTH
  },
